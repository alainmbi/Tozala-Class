      ...
      <div className="shell">
        <div className="overflow-hidden rounded-[2.5rem] bg-forest px-6 py-12 text-white sm:px-10 lg:px-14">
          <div className="grid gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
            <div>
              <p className="eyebrow !text-white/70">Cercle privé</p>
              ...
              <p className="mt-5 max-w-2xl text-base leading-8 text-white/75">
                Capsules limitées, invitations atelier, rendez-vous image et accès anticipé aux
                pièces maîtresses.
              </p>
            </div>
            <form className="rounded-[2rem] border border-white/10 bg-white/8 p-6 backdrop-blur">
              ...
              <p className="mt-4 text-xs leading-6 text-white/60">
                Aucun spam. Seulement des rendez-vous, des sorties et des pièces qui comptent.
              </p>
            </form>
          </div>
        </div>
